...
AIPATH = 'D:\Program Files\Adobe\Adobe Illustrator CS5\Support Files\Contents\Windows\Illustrator.exe'
path = Bar_Code.generate(ARGV[0]).gsub '/', "\\"

system "\"#{AIPATH}\" \"C:\\Users\\Lynch\\Documents\\Shy07\\LAServer\\#{path}\""
